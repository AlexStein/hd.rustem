...
'CONF_file_size'=>'Максимальный размер файла',
 ...
 'DASHBOARD_ticket_lock'=>'работаю я',
...
'TICKET_msg_lock'=>'Заявка принята в работу',
'TICKET_msg_lock_error'=>'Невозможно работать с заявкой. С ней работает ',
'TICKET_msg_unlock'=>'Работа с заявка прекращена',
...
'TICKET_action_unlock'=>'Приостановить работу',
...
'TICKET_t_a_lock'=>'заявка в работе',
'TICKET_t_a_unlock'=>'работа с заявкой приостановлена',
...
'TICKET_ACTION_unlock'=>'прекращена работа пользователем',
...
'JS_unlock'=>'Приостановить работу',
