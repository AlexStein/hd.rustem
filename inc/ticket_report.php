...
<div class="container">
  ...
  <div class="row" >
    <div class="col-md-9" style="width:100%;">
      ...
      <h5><center>C <?php echo $startdate ?> по <?php echo $enddate ?></center></h5>
<?php
        ...
        if ($priv_val == 0) {
            ...
            $stmt = $dbConnection->prepare('SELECT
                            ...
                            from tickets
                            where ((
                            (user_to_id=:user_id and unit_id IN ('.$in_query.') ) or
                            (user_to_id=:n1 and unit_id IN ('.$in_query2.') )
                            ) or (user_init_id=:user_id2 ))
                            and date_create > date_add(date_add(LAST_DAY(now()), interval 1 DAY),interval - 3 MONTH)
                            order by id DESC');
