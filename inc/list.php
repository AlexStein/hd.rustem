...
?>
    ...
    <div class="container">
        <div class="page-header" style="margin-top: -15px;">
            <div class="row">
              <div class="col-md-3"><h3><i class="fa fa-list-alt"></i> <?= lang('LIST_title'); ?></h3>
                <span class="text-muted">
                  <small>
                    <em>
<?php if ($priv_val != "2") { ?>
                      <span data-toggle="tooltip" data-placement="right" title="<?=view_array($text); ?>"><?=lang('LIST_pin')?>: <?=count($text); ?></span>
<?php } else if ($priv_val == "2") { echo $text; } ?>
                    </em>
                  </small>
                </span>
                </div>
        ...
        <div class="">
          ...
          <div class="text-center">
            ...
            <div class="pull-right">
              <div class="btn-group btn-group-xs">
                <button id="list_set_ticket" type="button" class="btn btn-default <?=$ac['25'];?>">25</button>
                <button id="list_set_ticket" type="button" class="btn btn-default <?=$ac['50'];?>">50</button>
                <button id="list_set_ticket" type="button" class="btn btn-default <?=$ac['100'];?>">100</button>
              </div>
            </div>
          </div>
        </div>
...
<?php if (isset($_GET['out'])) {
    ...
    if (isset($_SESSION['hd.rustem_list_out'])) {
        switch($_SESSION['hd.rustem_list_out']) {
            case '25':  $ac['25']="active";     break;
            case '50':  $ac['50']="active";     break;
            case '100':  $ac['100']="active";     break;
            default: $ac['25']="active";
        }
    }
