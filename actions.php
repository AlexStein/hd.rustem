...
?>
        ...
        if ($mode == "get_users_list") {
            ...
            foreach ($result as $row) {
                ...
                $u  = explode(",", $row['unit']);
                if (in_array($idzz, $u)) {
                    if (get_user_status_text($ud) == "online") {
                        $s = "status-online-icon";
                    } else if (get_user_status_text($ud) == "offline") {
...
?>
                    ...
                    <h5 style=" margin-bottom: 5px; "><i class="fa fa-file-text-o"></i> <a href="helper?h=<?= $row['hashname']; ?>"><?= $row['title']; ?></a> <small>(<?= lang('DASHBOARD_author'); ?>: <?= nameshort(name_of_user_ret($row['user_init_id'])); ?>)<?php
                    if ($priv_h == "yes") {
                        echo " 
	        <div class=\"btn-group\">
...
?>
                ...
                echo get_total_pages('in', $user_id);
?>" id="val_menu">
                <input type="hidden" value="<?php
                echo $user_id;
?>" id="user_id">
                ...
                foreach ($results as $row) {
                    ...
                    ////////////////////////////Показывает labels//////////////////////////////////////////////////////////////
                    if ($row['status'] == 1) {
                        $st    = "<span class=\"label label-success\"><i class=\"fa fa-check-circle\"></i> " . lang('t_list_a_oko') . " " . nameshort(name_of_user_ret($ob)) . "</span>";
...
?>
                    ...
                    echo $row['id'];
?>" class="<?= $style ?>">
                        <td style=" vertical-align: middle; "><small class="<?= $muclass; ?>"><center><?php
                    echo $row['id'];
?></center></small></td>
...
?></a></td>
                        <td style=" vertical-align: middle; "><small class="<?= $muclass; ?>"><?php
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" id="form_approve">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="tel" class="form-control input-sm" id="tel" placeholder="<?= lang('WORKER_tel_full'); ?>" value="<?php
            echo $tel_user . " " . $tel_ext;
?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="adr" class="form-control input-sm" id="adr" placeholder="<?= lang('WORKER_room'); ?>" value="<?php
            echo $adr;
?>">
                                    </div>
                                </div>
